/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1b3b0024d178bcad1daea7771244da9a)
// Runtime types generated with workerd@1.20260120.0 2025-01-27 nodejs_compat
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("./src/index");
        durableNamespaces: "ApiKeyManager" | "ContainerWorker";
    }
    interface StagingEnv {
        DOMAINS_BUCKET: R2Bucket;
        API_KEY_MANAGER: DurableObjectNamespace<import("./src/index").ApiKeyManagerStaging>;
        CONTAINER_WORKER: DurableObjectNamespace<import("./src/index").ContainerWorker>;
    }
    interface ProductionEnv {
        DOMAINS_BUCKET: R2Bucket;
        API_KEY_MANAGER: DurableObjectNamespace<import("./src/index").ApiKeyManagerProduction>;
        CONTAINER_WORKER: DurableObjectNamespace<import("./src/index").ContainerWorker>;
    }
    interface Env {
        DOMAINS_BUCKET: R2Bucket;
        API_KEY_MANAGER: DurableObjectNamespace<import("./src/index").ApiKeyManagerStaging> | DurableObjectNamespace<import("./src/index").ApiKeyManagerProduction> | DurableObjectNamespace<import("./src/index").ApiKeyManager>;
        CONTAINER_WORKER: DurableObjectNamespace<import("./src/index").ContainerWorker>;
    }
}
